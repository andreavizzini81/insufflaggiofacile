...
class __TwigTemplate_e61249e75739658385540e74119c9e7b extends Template
{
    private $source;
    private $macros = [];
...
{% for script in scripts.head %}
    {{ script|raw }}
{% endfor %}", "/partials/head_bundle.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/admin/partials/head_bundle.twig");
    }
}
