...
class __TwigTemplate_c202ad4e2bd43f9dab2d71614de2fd7b extends Template
{
    private $source;
    private $macros = [];
...
{% for script in scripts.body %}
    {{ script|raw }}
{% endfor %}", "/partials/body_bundle.twig", "/var/www/vhosts/insufflaggiofacile.it/staging/view/admin/partials/body_bundle.twig");
    }
}
