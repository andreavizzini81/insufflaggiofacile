...
/* user_list.twig */
class __TwigTemplate_b93ab7ded9b4703e4932ce27b2aa51ef extends Template
{
    private $source;
    private $macros = [];
...
{% include 'partials/pagination.twig' with {'data':data.pagination} only %}
{% endblock content %}", "user_list.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/admin/user_list.twig");
    }
}
