...
/* contact_list.twig */
class __TwigTemplate_a4e3653544a5d55814549a6f3944ad93 extends Template
{
    private $source;
    private $macros = [];
...
{% include 'partials/pagination.twig' with {'data':data.pagination} only %}
{% endblock content %}", "contact_list.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/admin/contact_list.twig");
    }
}
