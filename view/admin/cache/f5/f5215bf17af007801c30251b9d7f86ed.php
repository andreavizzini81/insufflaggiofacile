...
/* faq_list.twig */
class __TwigTemplate_b2feff5df21ccc8a5a2c15f4e5db0793 extends Template
{
    private $source;
    private $macros = [];
...
{% include 'partials/pagination.twig' with {'data':data.pagination} only %}
{% endblock content %}", "faq_list.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/admin/faq_list.twig");
    }
}
