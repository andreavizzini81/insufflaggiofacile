...
/* agency_list.twig */
class __TwigTemplate_8b79c94c1f8aed49c8b53e379c2c9423 extends Template
{
    private $source;
    private $macros = [];
...
{% include 'partials/pagination.twig' with {'data':data.pagination} only %}
{% endblock content %}", "agency_list.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/admin/agency_list.twig");
    }
}
