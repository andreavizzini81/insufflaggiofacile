...
class __TwigTemplate_444ff7bcf5053071b934466e0328a976 extends Template
{
    private $source;
    private $macros = [];
    ...
    {% if data.results is defined %}
        ...
        {% endif %}
    {% endif %}
</div>", "partials/pagination.twig", "/var/www/vhosts/insufflaggiofacile.it/staging/view/admin/partials/pagination.twig");
    }
}
