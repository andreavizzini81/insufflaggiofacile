...
class DealKanbanCard extends KanbanCard {
    ...
    render() {
        ...
        this.wrapper.innerHTML = `
            <a class="title" href="${res.path}deal/${this.id}" data-prop="title">${this.title}</a>
            ${subject ?? ''}
...
class CalendarEventModal {
    ...
    activityTypes = ['Seleziona un&rsquo;opzione...', 'Primo appuntamento telefonico', 'Chiamata richiesta planimetria', 'Chiamata discussione preventivo', 'Sopralluogo'];
