...
class __TwigTemplate_0f43ba76fe324e3ceb7cc5b62227b085 extends Template
{
    private $source;
    private $macros = [];
...
{% for script in scripts.body %}
    {{ script|raw }}
{% endfor %}", "/partials/body_bundle.twig", "/var/www/vhosts/insufflaggiofacile.it/staging/view/website/partials/body_bundle.twig");
    }
}
