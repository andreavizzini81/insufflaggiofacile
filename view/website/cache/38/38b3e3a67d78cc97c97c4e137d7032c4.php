...
/* insufflaggio.twig */
class __TwigTemplate_af420a5a5a3de46f7241701f0a9661cf extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<h1 class=\"color-main\">";
        // line 7
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "staticPage", [], "any", false, false, false, 7), "title", [], "any", false, false, false, 7), "html", null, true);
        echo "</h1>
...
\t\t\t\t\t\t<span class=\"bg-maincolor\">";
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "staticPage", [], "any", false, false, false, 13), "title", [], "any", false, false, false, 13), "html", null, true);
        echo "</span>
\t\t\t\t\t</li>
\t\t\t\t</ol>
\t\t\t</div>
...
\t\t\t\t<h3>";
        // line 27
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "staticPage", [], "any", false, false, false, 27), "title", [], "any", false, false, false, 27), "html", null, true);
        echo "</h3>

\t\t\t\t";
        // line 29
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "staticPage", [], "any", false, false, false, 29), "description", [], "any", false, false, false, 29);
        echo "
\t\t\t</div>
...
\t\t\t\t\t\t\t\t<a class=\"collapsed\" href=\"";
            ...
            echo "insufflaggio/";
            echo twig_escape_filter($this->env, twig_urlencode_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "staticPage", [], "any", false, false, false, 38), "title", [], "any", false, false, false, 38)), "html", null, true);
            echo "/";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "getId", [], "method", false, false, false, 38), "html", null, true);
            echo "\" aria-expanded=\"false\">
\t\t\t\t\t\t\t\t\t";
            // line 39
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "getTitle", [], "method", false, false, false, 39), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</h6>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t<textarea rows=\"7\" cols=\"45\" name=\"messaggio\" class=\"form-control\" placeholder=\"Descrivi il problema\" required>Voglio insufflare il mio immobile con: ";
        // line 111
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "staticPage", [], "any", false, false, false, 111), "title", [], "any", false, false, false, 111), "html", null, true);
        echo "</textarea>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"form-group has-placeholder text-left\">
...
";
    ...
    {
        return array (  192 => 111,  124 => 45,  112 => 39,  104 => 38,  99 => 35,  95 => 34,  87 => 29,  82 => 27,  65 => 13,  56 => 7,  50 => 3,  46 => 2,  35 => 1,);
    }
...
\t\t<div class=\"row\">
\t\t\t<div class=\"col-md-12 text-center text-lg-left\">
\t\t\t\t<h1 class=\"color-main\">{{ data.staticPage.title }}</h1>
\t\t\t\t<ol class=\"breadcrumb links-light\">
\t\t\t\t\t<li class=\"breadcrumb-item\">
\t\t\t\t\t\t<a href=\"/home\">Home</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li class=\"breadcrumb-item active\">
\t\t\t\t\t\t<span class=\"bg-maincolor\">{{ data.staticPage.title }}</span>
\t\t\t\t\t</li>
\t\t\t\t</ol>
\t\t\t</div>
...
\t\t\t\t<h3>{{ data.staticPage.title }}</h3>

\t\t\t\t{{ data.staticPage.description | raw }}
\t\t\t</div>

\t\t\t<div class=\"col-lg-5 service-tab\">
\t\t\t\t<div id=\"accordion01\" role=\"tablist\">
\t\t\t\t\t{% for product in f_nav['staticPage'] %}
\t\t\t\t\t<div class=\"card\">
\t\t\t\t\t\t<div class=\"card-header\">
\t\t\t\t\t\t\t<h6>
\t\t\t\t\t\t\t\t<a class=\"collapsed\" href=\"{{ path }}insufflaggio/{{ data.staticPage.title | url_encode }}/{{ product.getId() }}\" aria-expanded=\"false\">
\t\t\t\t\t\t\t\t\t{{ product.getTitle() }}
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</h6>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"form-group has-placeholder d-none\">
\t\t\t\t\t\t\t<textarea rows=\"7\" cols=\"45\" name=\"messaggio\" class=\"form-control\" placeholder=\"Descrivi il problema\" required>Voglio insufflare il mio immobile con: {{ data.staticPage.title }}</textarea>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"form-group has-placeholder text-left\">
\t\t\t\t\t\t\t<p>Inserisci le informazioni richieste di seguito, le useremo per contattarti ed inviarti il preventivo richiesto.</p>
\t\t\t\t\t\t</div>
...
{% endblock content %}", "insufflaggio.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/website/insufflaggio.twig");
    }
}
