...
class __TwigTemplate_f0d96251ed5f4afff51b6a7cfc935f5f extends Template
{
    private $source;
    private $macros = [];
...
{% for script in scripts.body %}
    {{ script|raw }}
{% endfor %}", "/partials/body_bundle.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/website/partials/body_bundle.twig");
    }
}
