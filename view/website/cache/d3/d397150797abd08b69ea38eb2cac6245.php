...
class __TwigTemplate_243ff1e03b6c2ebae78881cc21c734bc extends Template
{
    private $source;
    private $macros = [];
...
{% for script in scripts.head %}
    {{ script|raw }}
{% endfor %}", "/partials/head_bundle.twig", "/var/www/vhosts/insufflaggiofacile.it/staging/view/website/partials/head_bundle.twig");
    }
}
