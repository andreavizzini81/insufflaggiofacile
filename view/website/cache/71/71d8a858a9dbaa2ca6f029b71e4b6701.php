...
class __TwigTemplate_349e242b0e3072f9aa7b671fb2a2e6c3 extends Template
{
    private $source;
    private $macros = [];
...
{% for script in scripts.head %}
    {{ script|raw }}
{% endfor %}", "/partials/head_bundle.twig", "/var/www/vhosts/insufflaggiofacile.it/httpdocs/view/website/partials/head_bundle.twig");
    }
}
